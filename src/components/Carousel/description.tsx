...
const Description = ({ activeImage, clickNext, clickPrev }: Props) => {
  return (
    <div className="grid place-items-start w-full bg-slider relative md:rounded-tr-3xl md:rounded-br-3xl">
      {images.map((elem, idx) => (
        <div
          key={idx}
          className={`${
        ...
        >
          <motion.div
            ...
            className="w-full"
          >
            <div className="py-16 pt-0 text-5xl text-white font-extrabold">{elem.title}</div>
